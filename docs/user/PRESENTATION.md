...
| 68000 instruction set (~80 opcodes) | 🚧 71 of ~80 (`NOP`, `MOVE`, `MOVEA`, `MOVEQ`, `MOVEM`, `MOVEP`, `MOVE SR`, `MOVE to CCR`, `LEA`, `PEA`, `SWAP`, `EXG`, `ADD`, `ADDI`, `ADDX`, `ADDA`, `SUB`, `SUBI`, `SUBX`, `SUBA`, `ADDQ`, `SUBQ`, `CMP`, `CMPI`, `CMPM`, `CMPA`, `CHK`, `MULU`, `MULS`, `DIVU`, `DIVS`, `ABCD`, `SBCD`, `NBCD`, `Bcc`/`BRA`, `DBcc`, `Scc`, `BTST`, `BCHG`, `BCLR`, `BSET`, `AND`, `ANDI`, `OR`, `ORI`, `XOR`, `EORI`, `NOT`, `CLR`, `NEG`, `NEGX`, `TST`, `TAS`, `EXT`, `JMP`, `JSR`, `BSR`, `RTS`, `RTR`, `LINK`, `UNLK`, `ASL`, `ASR`, `LSL`, `LSR`, `ROL`, `ROR`, `ROXL`, `ROXR`, `ILLEGAL`, `TRAPV`) — see [Reference](./REFERENCE.md). The only remaining gap is `ANDI`/`ORI`/`EORI`'s own `#imm,CCR`/`#imm,SR` special forms, which **don't fail cleanly if hand-encoded** — see [Reference](./REFERENCE.md#why-doesnt-this-emulator-implement-rtestopresetmove-sr) |
