...
| Assembler (turns `.asm` source into runnable bytecode) | 🚧 Library done for every instruction; only PC-relative and indexed operands are missing (see [Reference](./REFERENCE.md#writing-assembly-source)); connected to the Editor/Debugger |
