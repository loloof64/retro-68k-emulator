...
| 68000 instruction set (~80 opcodes) | 🚧 34 of ~80 (`NOP`, `MOVE`, `MOVEA`, `MOVEQ`, `LEA`, `ADD`, `SUB`, `CMP`, `MULU`, `MULS`, `DIVU`, `DIVS`, `Bcc`/`BRA`, `DBcc`, `Scc`, `BTST`, `AND`, `OR`, `XOR`, `NOT`, `CLR`, `NEG`, `TST`, `SWAP`, `EXT`, `JSR`, `BSR`, `RTS`, `ASL`, `ASR`, `LSL`, `LSR`, `ROL`, `ROR`) — see [Reference](./REFERENCE.md) |
