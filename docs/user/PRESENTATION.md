...
| 68000 instruction set (~80 opcodes) | 🚧 20 of ~80 (`NOP`, `MOVE`, `MOVEQ`, `ADD`, `SUB`, `CMP`, `Bcc`/`BRA`, `BTST`, `AND`, `OR`, `XOR`, `NOT`, `CLR`, `NEG`, `TST`, `SWAP`, `EXT`, `JSR`, `BSR`, `RTS`) — see [Reference](./REFERENCE.md) |
