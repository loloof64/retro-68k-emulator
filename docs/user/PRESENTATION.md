...
| 68000 instruction set (~80 opcodes) | 🚧 50 of ~80 (`NOP`, `MOVE`, `MOVEA`, `MOVEQ`, `MOVEM`, `LEA`, `PEA`, `ADD`, `ADDA`, `SUB`, `SUBA`, `ADDQ`, `SUBQ`, `CMP`, `CMPA`, `CHK`, `MULU`, `MULS`, `DIVU`, `DIVS`, `ABCD`, `SBCD`, `NBCD`, `Bcc`/`BRA`, `DBcc`, `Scc`, `BTST`, `AND`, `OR`, `XOR`, `NOT`, `CLR`, `NEG`, `TST`, `TAS`, `SWAP`, `EXT`, `JSR`, `BSR`, `RTS`, `LINK`, `UNLK`, `ASL`, `ASR`, `LSL`, `LSR`, `ROL`, `ROR`, `ROXL`, `ROXR`) — see [Reference](./REFERENCE.md) |
