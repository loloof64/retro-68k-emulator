...
| 68000 instruction set (~80 opcodes) | 🚧 52 of ~80 (`NOP`, `MOVE`, `MOVEA`, `MOVEQ`, `MOVEM`, `LEA`, `PEA`, `SWAP`, `EXG`, `ADD`, `ADDA`, `SUB`, `SUBA`, `ADDQ`, `SUBQ`, `CMP`, `CMPA`, `CHK`, `MULU`, `MULS`, `DIVU`, `DIVS`, `ABCD`, `SBCD`, `NBCD`, `Bcc`/`BRA`, `DBcc`, `Scc`, `BTST`, `AND`, `OR`, `XOR`, `NOT`, `CLR`, `NEG`, `TST`, `TAS`, `EXT`, `JMP`, `JSR`, `BSR`, `RTS`, `LINK`, `UNLK`, `ASL`, `ASR`, `LSL`, `LSR`, `ROL`, `ROR`, `ROXL`, `ROXR`) — see [Reference](./REFERENCE.md) |
