...
| 68000 instruction set (~80 opcodes) | 🚧 28 of ~80 (`NOP`, `MOVE`, `MOVEA`, `MOVEQ`, `ADD`, `SUB`, `CMP`, `Bcc`/`BRA`, `DBRA`, `BTST`, `AND`, `OR`, `XOR`, `NOT`, `CLR`, `NEG`, `TST`, `SWAP`, `EXT`, `JSR`, `BSR`, `RTS`, `ASL`, `ASR`, `LSL`, `LSR`, `ROL`, `ROR`) — see [Reference](./REFERENCE.md) |
