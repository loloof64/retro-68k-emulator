...
| 68000 instruction set (~80 opcodes) | 🚧 58 of ~80 (`NOP`, `MOVE`, `MOVEA`, `MOVEQ`, `MOVEM`, `MOVEP`, `LEA`, `PEA`, `SWAP`, `EXG`, `ADD`, `ADDA`, `SUB`, `SUBA`, `ADDQ`, `SUBQ`, `CMP`, `CMPA`, `CHK`, `MULU`, `MULS`, `DIVU`, `DIVS`, `ABCD`, `SBCD`, `NBCD`, `Bcc`/`BRA`, `DBcc`, `Scc`, `BTST`, `BCHG`, `BCLR`, `BSET`, `AND`, `OR`, `XOR`, `NOT`, `CLR`, `NEG`, `TST`, `TAS`, `EXT`, `JMP`, `JSR`, `BSR`, `RTS`, `LINK`, `UNLK`, `ASL`, `ASR`, `LSL`, `LSR`, `ROL`, `ROR`, `ROXL`, `ROXR`, `ILLEGAL`, `TRAPV`) — see [Reference](./REFERENCE.md). A few ordinary instructions (`ADDI`/`SUBI`/`ANDI`/`ORI`/`EORI`/`CMPI`, `ADDX`/`SUBX`/`NEGX`, `CMPM`, `RTR`, `MOVE to/from CCR`) aren't implemented yet and **don't fail cleanly if hand-encoded** — see [Reference](./REFERENCE.md#why-doesnt-this-emulator-implement-rtestopresetmove-sr) |
