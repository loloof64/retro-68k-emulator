...
| Assembler (turns `.asm` source into runnable bytecode) | 🚧 Library done for a common subset of instructions (see [Reference](./REFERENCE.md#writing-assembly-source)); not yet connected to the Editor |
