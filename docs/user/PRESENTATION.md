...
| 68000 instruction set (~80 opcodes) | 🚧 67 of ~80 (`NOP`, `MOVE`, `MOVEA`, `MOVEQ`, `MOVEM`, `MOVEP`, `LEA`, `PEA`, `SWAP`, `EXG`, `ADD`, `ADDI`, `ADDX`, `ADDA`, `SUB`, `SUBI`, `SUBX`, `SUBA`, `ADDQ`, `SUBQ`, `CMP`, `CMPI`, `CMPA`, `CHK`, `MULU`, `MULS`, `DIVU`, `DIVS`, `ABCD`, `SBCD`, `NBCD`, `Bcc`/`BRA`, `DBcc`, `Scc`, `BTST`, `BCHG`, `BCLR`, `BSET`, `AND`, `ANDI`, `OR`, `ORI`, `XOR`, `EORI`, `NOT`, `CLR`, `NEG`, `NEGX`, `TST`, `TAS`, `EXT`, `JMP`, `JSR`, `BSR`, `RTS`, `LINK`, `UNLK`, `ASL`, `ASR`, `LSL`, `LSR`, `ROL`, `ROR`, `ROXL`, `ROXR`, `ILLEGAL`, `TRAPV`) — see [Reference](./REFERENCE.md). A few ordinary instructions (`CMPM`, `RTR`, `MOVE to/from CCR`, `ANDI`/`ORI`/`EORI` to `CCR`/`SR`) aren't implemented yet and **don't fail cleanly if hand-encoded** — see [Reference](./REFERENCE.md#why-doesnt-this-emulator-implement-rtestopresetmove-sr) |
