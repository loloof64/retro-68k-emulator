...
| Assembler (turns `.asm` source into runnable bytecode) | 🚧 Library done for a common subset of instructions (see [Reference](./REFERENCE.md#writing-assembly-source)); connected to the Editor/Debugger |
