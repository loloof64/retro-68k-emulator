export const en = {
  ...
  'speed.title': 'Instructions executed per screen refresh, about 60 times per second (Run only)',
...
export const fr: Record<MessageKey, string> = {
  ...
  'speed.title': 'Instructions exécutées par rafraîchissement de l\'écran, environ 60 fois par seconde (Exécuter uniquement)',
...
export const es: Record<MessageKey, string> = {
  ...
  'speed.title': 'Instrucciones ejecutadas por refresco de pantalla, unas 60 veces por segundo (solo Ejecutar)',
